...
const Navbar = () => {
  const user: any = {name: "Sumit Singh Rajput", email: "iamcodynex@gmail.com", isAdmin: true }
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                    ...
                    <div onClick={() => setUserMenuOpen(false)}>
                      ...
                      {user && <Link to='/myorders' className="dropdown-link"><PackageIcon size={16} />My Orders</Link>}
                      ...
                      {user?.isAdmin && (
                        <Link to='/admin/products'
                          className="dropdown-link"><ShieldIcon className="text-app-orange-dark" size={16} />
